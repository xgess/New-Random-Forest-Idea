...
jpeg(file="ALGAE_method1.jpg")
	plot.roc(algae.oldRFpred, algae.test$a1, col = "blue")
	lines.roc(algae.newRFpred,algae.test$a1, col = "red")
	lines.roc(algae.newRFpred1, algae.test$a1, col = "green")
	leg.txt <- c("Original RF, M=4", "My RF, M=4", "METHOD 1")
	legend("bottomright", leg.txt, col=c("blue","red"), lty=c(1, 1, 1), cex=0.8, inset=0.02)
dev.off()
...
jpeg(file="ALGAE_method2.jpg")
	plot.roc(algae.oldRFpred, algae.test$a1, col = "blue")
	lines.roc(algae.newRFpred,algae.test$a1, col = "red")
	lines.roc(algae.newRFpred2, algae.test$a1, col = "green")
	leg.txt <- c("Original RF, M=4", "My RF, M=4", "METHOD 2")
	legend("bottomright", leg.txt, col=c("blue","red"), lty=c(1, 1, 1), cex=0.8, inset=0.02)
dev.off()
...
jpeg(file="ALGAE_method3.jpg")
	plot.roc(algae.oldRFpred, algae.test$a1, col = "blue")
	lines.roc(algae.newRFpred,algae.test$a1, col = "red")
	lines.roc(algae.newRFpred3, algae.test$a1, col = "green")
	leg.txt <- c("Original RF, M=4", "My RF, M=4", "METHOD 3")
	legend("bottomright", leg.txt, col=c("blue","red"), lty=c(1, 1, 1), cex=0.8, inset=0.02)
dev.off()
...
jpeg(file="ALGAE_method4.jpg")
	plot.roc(algae.oldRFpred, algae.test$a1, col = "blue")
	lines.roc(algae.newRFpred,algae.test$a1, col = "red")
	lines.roc(algae.newRFpred4, algae.test$a1, col = "green")
	leg.txt <- c("Original RF, M=4", "My RF, M=4", "METHOD 4")
	legend("bottomright", leg.txt, col=c("blue","red"), lty=c(1, 1, 1), cex=0.8, inset=0.02)
dev.off()
...
jpeg(file="ALGAE_method5.jpg")
	plot.roc(algae.oldRFpred, algae.test$a1, col = "blue")
	lines.roc(algae.newRFpred,algae.test$a1, col = "red")
	lines.roc(algae.newRFpred5, algae.test$a1, col = "green")
	leg.txt <- c("Original RF, M=4", "My RF, M=4", "METHOD 5")
	legend("bottomright", leg.txt, col=c("blue","red"), lty=c(1, 1, 1), cex=0.8, inset=0.02)
dev.off()
...
jpeg(file="ALGAE_method6.jpg")
	plot.roc(algae.oldRFpred, algae.test$a1, col = "blue")
	lines.roc(algae.newRFpred,algae.test$a1, col = "red")
	lines.roc(algae.newRFpred6, algae.test$a1, col = "green")
	leg.txt <- c("Original RF, M=4", "My RF, M=4", "METHOD 6")
	legend("bottomright", leg.txt, col=c("blue","red"), lty=c(1, 1, 1), cex=0.8, inset=0.02)
dev.off()
